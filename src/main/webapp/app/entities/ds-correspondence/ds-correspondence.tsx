...
import { getEntities, reset } from './ds-correspondence.reducer';
...
export class DSCorrespondence extends React.Component<IDSCorrespondenceProps, IDSCorrespondenceState> {
  state: IDSCorrespondenceState = {
  ...
  render() {
    const { dSCorrespondenceList, match } = this.props;
    return (
      <div>
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('subcategory')}>
...
const mapStateToProps = ({ dSCorrespondence }: IRootState) => ({
  dSCorrespondenceList: dSCorrespondence.entities,
  totalItems: dSCorrespondence.totalItems,
  links: dSCorrespondence.links,
  entity: dSCorrespondence.entity,
  updateSuccess: dSCorrespondence.updateSuccess
});
